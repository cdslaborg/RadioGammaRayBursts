...
set    SYNTHETIC_SAMPLE_OBJ_BUILD_ENABLED=FALSE
set    SYNTHETIC_SAMPLE_EXE_BUILD_ENABLED=FALSE
...
::if not defined                   COMPILER_VERSION set                    COMPILER_VERSION=19.0.0.117
