...
if !THRESH_MODEL!==B07 set "FPP_FLAGS_SYNSAM=!FPP_FLAGS_SYNSAM! /define:SWIFT_B07_THRESH_ENABLED"
if !THRESH_MODEL!==B10 set "FPP_FLAGS_SYNSAM=!FPP_FLAGS_SYNSAM! /define:SWIFT_B10_THRESH_ENABLED"
if !THRESH_MODEL!==BATSE set "FPP_FLAGS_SYNSAM=!FPP_FLAGS_SYNSAM! /define:BATSE_THRESH_ENABLED"
echo.
