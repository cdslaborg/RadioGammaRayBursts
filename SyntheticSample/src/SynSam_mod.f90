...
#else
#error "kfac must be oneThird in SynSam_mod.f90. Otherwise, remove this error command."
#endif
...
!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    subroutine genSynSam    ( ParaPost &
        ...
        integer(IK) , intent(in)                        :: numSynSam
        ...
        nicoleZoneUsed = .not. synRedZoneUsed

        if (nicoleEisoUsed) then

            sampleSize = NicoleRadio%count
